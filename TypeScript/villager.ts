...
class Villager {
    ...
    pockets: any[];
    tools: any;
    constructor(public name: string, birthday: Date, catchPhrase: string) { // can either put public, or declare
  ...
  const villager = new Villager("BJ",new Date("09-15-1900"),"Hey there:");
